...
{   customername=document.getElementById("customerName").value;
	...
	var alphabetnum=/^[a-zA-Z]+$/;
	var alphnum=/^[0-9a-zA-Z]+$/;
	var numlen=/^[0-9]+$/;
	if(customername.match(alphabetnum) && address.match(alphnum) && age.length<=3 && age.match(numlen))
		{
		return true;
		}
	else
...
function drop_homefunc(){
	var temp=document.getElementById("drop_home_id");
...
<h2 style="text-decoration:underline">Update Customer</h2><br>
<table>
<form method="post" action="update.jsp" onsubmit="return validate()">
<tr><td>Customer SSN ID:<br><br></td><td><%= customer.getSsnId() %><br><br></td></tr>
<tr><td>Customer ID:<br><br></td><td><%= customer.getCustomerId() %><br><br></td></tr>
<tr><td>Old Customer Name:<br><br></td><td><%= customer.getCustomerName() %><br><br></td></tr>
<tr><td>New Customer Name:<span class="required" style="color:red">*</span><br><br></td><td><input type="text" name="customerName" id="customerName" required><br><br></td></tr>
<tr><td>Old Address:<br><br></td><td><%= customer.getAddress() %><br><br></td></tr>
<tr><td>New Address:<span class="required" style="color:red">*</span><br><br></td><td><input type="text" name="address" id="address"><br><br></td></tr>
<tr><td>Old Age:<br><br></td><td><%= customer.getAge() %><br><br></td></tr>
<tr><td>New Age:<span class="required" style="color:red">*</span><br><br></td><td><input type="text" name="age" id="age"><br><br></td></tr>
<tr><td>(<span class="required" style="color:red">*</span>) Fields are compulsory</td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="Update" style="padding:4px;background-color:black;color:yellow"></td></tr>
