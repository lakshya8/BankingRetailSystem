...
function validate()
{
	...
	document.getElementById("ac1").value=document.getElementById("acc").value;
	document.getElementById("ac2").value=document.getElementById("acc2").value;
}
function myFunction() {
...
<%} %>
<tr><td>
<input type="hidden" name="ac1" id="ac1">
<input type="hidden" name="ac2" id="ac2">
<input type="submit" value="Select" formaction="check_AccountTransferCashier.jsp" style="padding:4px;background-color:black;color:yellow"><br><br></td>&nbsp&nbsp
<td>
<input type="submit" value="Cancel" formaction="cashier.jsp" style="padding:4px;background-color:black;color:yellow"><br><br></td></tr>
</table>
</form>
