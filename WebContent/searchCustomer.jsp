...
function validate()
{
	...
	if(customer_id.length==0 && ssn_id.length==0)
		{
		alert("Enter Details");
		return false;
		}
	if(customer_id.length==0)
		...
		if(ssn_id.length!=9)
			{
			alert("Please Enter Correct SSN-ID");
			return false;
			}
		else
			{
			document.getElementById("action").value="ssn";
...
<form id="ff" method="post" action="search.jsp" >
<table>
<tr>
<td>Enter Customer ID:<br><br></td>
<input type="hidden" name="action" id="action">
<td>
<input type="text" name="customer_Id" id="customer_Id"><br><br></td>
</tr>
<tr><td colspan="2" align="center">Or<br><br><td></td></tr>
<tr>
<td>Enter SSN ID:<br><br></td>
<td><input type="text" name="ssn_id" id="ssn_id"><br><br></td>
</tr>
