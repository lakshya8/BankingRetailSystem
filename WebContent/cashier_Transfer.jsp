...
<% AccountBean account1=(AccountBean)session.getAttribute("oneaccount"); 
AccountBean account2=(AccountBean)session.getAttribute("twoaccount");
%>
function myFunction() {
    ...
    <td class="con" valign="top">
    	<div id="heade1">
            ...
            <form action="transfer.jsp" method ="post">
                <center><h1>Transfer Money</h1><br><br>
            <ul>
                <li><p><b>Customer ID : <%=account1.getCustomer_Id() %></b><br>
         </p></li>
                <li><p><b>Account ID-1 : <%=account1.getAccount_id() %></b><br>
         </p></li>
                <li><p><b>Balance-1 : <%=account1.getDeposit() %></b><br>
         </p></li>
                <li><p><b>Account ID-2 : <%=account2.getAccount_id() %></b><br>
         </p></li>
         <li><p><b>Balance-2 : <%=account2.getDeposit() %></b><br>
         </p></li>
                <li><p><b>Transfer Amount : <input type="text" name="deposit" id="deposit"></b>
                    </p></li>
                    <table><tr><td>
                <input type="submit" class="button" value="Submit" onclick="return ctck()">&nbsp;&nbsp;</td>  
                   <td><input type="submit" class="button" value="Cancel" formaction="executive.jsp"></center><br></td></tr>
                   </table>
      </ul>
        </form>
        </div>
