...
<% for(AccountBean i:a)
	{%>
	<option value=<%=i.getAccount_id() %>><%=i.getAccount_id() %></option>
...
<input type="submit" value="Confirm Delete" formaction="delete_Account.jsp" style="padding:4px;background-color:black;color:yellow"><br><br></td>&nbsp&nbsp
<td>
