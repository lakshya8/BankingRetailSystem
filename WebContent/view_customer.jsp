...
function myFunctio(id,i) {
	...
	xmlhttp.open("GET","http://localhost:8081/RetailBanking/refresh.jsp?id="+id,true);
	xmlhttp.send();
...
<div class="container" style="margin-top:20px">
  ...
  <tr>
   ...
   <tr>
         ...
         <td><button onclick= "myFunctio(<%= rs.getString("Customer_Id")%>,<%=i%>)">Refresh</button></td>
         <td><a href="http://localhost:8081/BankingRetail/view_profile.jsp?msg=<%=rs.getString("Customer_Id") %>">View Profile</a></td>
        </tr>
                          <%
                }
            }
