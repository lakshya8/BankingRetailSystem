...
<h1 style="text-align:center;">Create Account</h1>
	...
	<td width="166"> 
	<input type="text" id="customerId" name="customer_id" required="required" class="form-control" maxlength="9" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" />
	</div></td></tr>
	...
	<select id="selectAccountType" size="1" name="account_type" required="required" class="form-control">
	...
	<td width="166"> 
	<input type="text" id="amount" name="deposit_amount" required="required" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" />
	</div></td></tr>
