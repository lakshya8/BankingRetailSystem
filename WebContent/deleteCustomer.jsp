...
<div style="text-align:center;"><h2>Delete Customer<br></h2>
</div>
<br><br>
<table>
<tr>
<td><b>Ssn Id:<br><br></b></td><td><input type="text" name="ssnid" readonly value=<%=customer.getSsnId() %> readonly><br><br></td></tr>
<tr><td><b>Customer Id:</b><br><br></td><td><input type="text" name="ssnid" readonly value=<%=customer.getCustomerId() %> readonly><br><br></td></tr>
<tr><td><b>Customer Name:</b><br><br></td><td><input type="text" name="ssnid" readonly value=<%=customer.getCustomerName() %> readonly><br><br></td></tr>
<tr><td><b>Age:</b><br><br></td><td><input type="text" name="ssnid" readonly value=<%=customer.getAge() %> readonly><br><br></td></tr>
<tr><td><b>Address:</b><br><br></td><td><input type="text" name="ssnid" readonly value=<%=customer.getAddress() %> readonly><br><br></td></tr>
<tr><td><input type="submit" name="del" value="Confirm Delete" formaction="delete_Customer.jsp" style="padding:4px;background-color:black;color:yellow"></td><td align="center"><input type="submit" name="del" value="Cancel" formaction="executive.jsp" style="padding:4px;background-color:black;color:yellow"></td></tr>
</table>
</form>
